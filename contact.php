...
{//data is submitted show it
     ...
     */
     ...
     $to      = 'jnorberg1550@gmail.com';
     $subject = 'Clean Contact Page';
     //$message = 'hello from' .$_POST['Name'];
     $message= process_post();
     $replyTo = 'norbergjill@gmail.com';
     $headers = 'From: jnorberg@itc240jn.com' . PHP_EOL . 
     ...
     <p><a< href "">BACK</a></p>';
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                ...
                placeholder="Message" id="message" name = "Message" required data-validation-required-message="Please enter a message."></textarea>
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
